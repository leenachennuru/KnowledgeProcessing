...
\begin{document}
	...
	\begin{frame}{Moving the Line's Boundaries}
		...
		\begin{block}{Example}
			...
			\includegraphics[width=\textwidth]{images/smooth_transitions_case_1.png}
		\end{block}
	\end{frame}
	...
	\begin{frame}{Moving the Line's Boundaries}
		...
		\begin{block}{Example}
			...
			\includegraphics[width=\textwidth]{images/smooth_transitions_case_2.png}
		\end{block}
	\end{frame}
	...
	\begin{frame}{Moving the Line's Interior}
		...
		\begin{block}{Example}
			...
			\includegraphics[width=\textwidth]{images/smooth_transitions_case_3.png}
		\end{block}
	\end{frame}
	...
	\begin{frame}{Moving the Line's Interior}
		...
		\begin{block}{Example}
			...
			\includegraphics[width=\textwidth]{images/smooth_transitions_case_4.png}
		\end{block}
	\end{frame}
...
%			\bibitem{Heller2008}
%			A.~Heller.
%			\newblock Ein Entscheidungsverfahren für die Presburger Arithmetik.
